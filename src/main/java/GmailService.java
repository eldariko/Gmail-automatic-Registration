...
public class GmailService {
    private static Properties prop;
     ...
     GmailService(Properties prop)  {
        GmailService.prop=prop;
         TOKENS_DIRECTORY_PATH = prop.getProperty("TOKENS_DIRECTORY_PATH");
         CREDENTIALS_FILE_PATH = prop.getProperty("CREDENTIALS_FILE_PATH");
    }
    ...
    public  Message sendMessage(Gmail service,
        ...
        try {
            message = this.createMessageWithEmail(emailContent);
    ...
    public static boolean isBounced(Gmail service, String threadId) throws IOException {
        List<Message> list = service.users().messages().list(prop.getProperty("userId"))
